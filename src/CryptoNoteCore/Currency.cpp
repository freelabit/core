...
difficulty_type Currency::nextDifficultyV3(std::vector<uint64_t> timestamps,
  ...
  int64_t N = static_cast<int64_t>(parameters::DIFFICULTY_WINDOW_V3) - 1;
  ...
  double LWMA(0), sum_inverse_D(0), harmonic_mean_D(0), nextDifficultyV3(0);
  int64_t solveTime(0);
  ...
  nextDifficultyV3 = harmonic_mean_D * T / LWMA;
  uint64_t next_difficulty = static_cast<uint64_t>(nextDifficultyV3);
...
CurrencyBuilder::CurrencyBuilder(Logging::ILogger& log) : m_currency(log) {
  ...
  blockFutureTimeLimit_V3(parameters::CRYPTONOTE_BLOCK_FUTURE_TIME_LIMIT_V3);
