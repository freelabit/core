...
bool core::get_block_template(Block& b, const AccountPublicAddress& adr, difficulty_type& diffic, uint32_t& height, const BinaryArray& ex_nonce) {
...

  {
    ...
    //@jagerman's patch 
    //@see https://github.com/xun-project/UltraNote/blob/5be3c4e3416896d982014fccfb334a8eb60d9511/src/CryptoNoteCore/Core.cpp#L340
    uint64_t check_window = b.majorVersion < 3 ? parameters::BLOCKCHAIN_TIMESTAMP_CHECK_WINDOW : parameters::BLOCKCHAIN_TIMESTAMP_CHECK_WINDOW_V3;
