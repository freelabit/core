...
public:
  ...
  uint64_t blockFutureTimeLimit_V3() const { return m_blockFutureTimeLimit_V3; }
...
//  uint64_t genesisBlockReward() const { return m_genesisBlockReward; }
  ...
  size_t difficultyBlocksCountV3() const {return parameters::DIFFICULTY_WINDOW_V3 + 1;} 
...
private:
  ...
  uint64_t m_blockFutureTimeLimit_V3;
...
public:
 ...
 // Transaction generateGenesisTransaction(const std::vector<AccountPublicAddress>& targets);
  ...
  CurrencyBuilder& blockFutureTimeLimit_V3(uint64_t val) { m_currency.m_blockFutureTimeLimit_V3 = val; return *this; }
